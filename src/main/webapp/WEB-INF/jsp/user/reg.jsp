                  ...
                  <div class="layui-form layui-form-pane">
                        <form id="form1" method="post" action="${pageContext.request.contextPath}/user/doreg">
                            ...
                            <div class="layui-form-item fly-form-app">
                                ...
                                <a href="${pageContext.request.contextPath}/oauth/qqLogin" onclick="layer.msg('正在通过QQ登入', {icon:16, shade: 0.1, time:0})" class="iconfont icon-qq" title="QQ登入"></a>
                                <a href="${pageContext.request.contextPath}/oauth/weiboLogin" onclick="layer.msg('正在通过微博登入', {icon:16, shade: 0.1, time:0})" class="iconfont icon-weibo" title="微博登入"></a>
                            </div>
                        </form>
                    </div>
                </div>
